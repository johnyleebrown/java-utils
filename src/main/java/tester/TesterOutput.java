...
public class TesterOutput {
	...
	private int getLineLen() {
		...
		int classNameLen =
				calculateLineLenFromClassName(solutionClass) + DOT_JAVA_TEXT_LENGTH;
	...
	public void printIntermediateNok(int i, final List<Object> results,
			final List<Object> expectations, final List<Object> orExpectations) {
		String NUM = String.valueOf(i + 1);
		String NOK = " NOK";
