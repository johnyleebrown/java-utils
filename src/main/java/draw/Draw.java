 ...
 * @author Kevin Wayne
 */
public final class Draw implements ActionListener, MouseListener, MouseMotionListener,
		KeyListener {
...
//	private static final Font DEFAULT_FONT = new Font("SansSerif", Font.PLAIN, 16);
	private static final Font DEFAULT_FONT = new Font("Menlo", Font.ITALIC, 16);
	...
	/**
	 * Sets the upper-left hand corner of the drawing window to be (x, y), where (0, 0) is
	 * upper left.
	 ...
	 * @throws IllegalArgumentException if either {@code min} or {@code max} is either NaN
	 *                                  or infinite
	 */
	 ...
	 * @throws IllegalArgumentException if either {@code x} or {@code y} is either NaN or
	 *                                  infinite
	 */
	 ...
	 * @throws IllegalArgumentException if the image filename is invalid
	 * @throws IllegalArgumentException if {@code x}, {@code y}, {@code degrees} is NaN or
	 *                                  infinite
	 ...
	 * @param degrees is the number of degrees to rotate counterclockwise
	 * @throws IllegalArgumentException if {@code text} is {@code null}
	 * @throws IllegalArgumentException if {@code x}, {@code y}, or {@code degrees} is
	...
	/**
	 * Writes the given text string in the current font, left-aligned at (<em>x</em>,
	 * <em>y</em>).
	...
	/**
	 * Writes the given text string in the current font, right-aligned at (<em>x</em>,
	 * <em>y</em>).
	 * @param x    the <em>x</em>-coordinate of the text
	 * @param y    the <em>y</em>-coordinate of the text
	 * @param text the text to write
